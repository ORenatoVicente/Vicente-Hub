...
local Window = OrionLib:MakeWindow({Name = "Night Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Night Hub"})

OrionLib:MakeNotification({
	Name = "Night Hub",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://75437522435433",
	Time = 7
})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://82810003460851",
    PremiumOnly = false
})
